...
void ImGuizmoEditTransform(KdMatrix& mat, const KdMatrix& mView, 
	                       const KdMatrix& mProj, const DirectX::BoundingBox* bb) 
{  
	// 操作パネル  
	...
	ImGuizmo::DecomposeMatrixToComponents(mat, matrixTranslation, matrixRotation, 
		                                  matrixScale);  
	// 操作  
	...
	ImGuizmo::Manipulate(mView, mProj, mCurrentGizmoOperation, mCurrentGizmoMode, 
		                 mat, NULL, useSnap ? &snap.x : NULL,  
